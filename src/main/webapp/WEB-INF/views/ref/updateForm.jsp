...
<div id="wrap">
	...
	<!-- container -->
	<div id="container">
		<form method="post" action="/ref/update/">
			<fieldset>
				...
				<div class="table_grp">
					<div class="table_type_01">
						<table>
							...
							<tbody>
								<tr>
									<th scope="row">이름</th>
									<td><input type="text" class="txt w100" name="id" readonly="readonly" value="${user.id }"/></td>
								</tr>
								<tr>
									<th scope="row">제목</th>
									<td>
					...
					<div class="btn_align_02">
						...
						<a href="/ref/list" class="btn btnF_03 btnC_02">
							<span>글목록</span>
						</a>
					</div>
				</div>
